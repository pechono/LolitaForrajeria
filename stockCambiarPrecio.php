  ...
  <nav class="navbar navbar-expand-lg bg-light >
    <div class= "container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="container-fluid">
            <form class="d-flex" role="search" action="stockCambiarPrecio.php" method="POST">
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $producto->detalles ?></td>
                                       <form action="cambiarPrecio.php" method="post">
                                                    ...
                                                    <td> <button class="btn btn-success btn-sm"> Cambiar Precio </button> </td>
                                        </form>              
